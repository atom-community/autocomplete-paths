...
export default {
  ...
  activate: function () {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      'autocomplete-paths-ignore-circle-symlinks:rebuild-cache': () => {
    ...
    const cacheOptions = [
      ...
      'autocomplete-paths-ignore-circle-symlinks.ignoreSubmodules',
      'autocomplete-paths-ignore-circle-symlinks.ignoredNames',
      'autocomplete-paths-ignore-circle-symlinks.ignoredPatterns'
    ]
    ...
    const scopeOptions = ['autocomplete-paths-ignore-circle-symlinks.scopes']
    for (let key in OptionScopes) {
      scopeOptions.push(`autocomplete-paths-ignore-circle-symlinks.${key}`)
    }
  ...
  _displayStatusBarTile () {
    ...
    this._statusBarElement = document.createElement('autocomplete-paths-ignore-circle-symlinks-status-bar')
